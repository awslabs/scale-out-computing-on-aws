...
class Config(object):
    JOBS = [
        {"id": "validate_db_permissions", "func": validate_db_permissions, "trigger": "interval", "minutes": 60},
        {
        ...
        {"id": "schedule_auto_start", "func": schedule_auto_start, "trigger": "interval", "minutes": 10},
        {"id": "schedule_auto_stop", "func": schedule_auto_stop, "trigger": "interval", "minutes": 5},
        {"id": "clean_tmp_folders", "func": clean_tmp_folders, "trigger": "interval", "hours": 1},
    ]
