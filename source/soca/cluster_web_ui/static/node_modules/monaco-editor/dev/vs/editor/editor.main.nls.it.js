...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/base/browser/ui/list/listWidget": [
		"{0}. utilizzare i tasti di navigazione per navigare.",
	],
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Controlla il comportamento del comando \'Vai a definizione\' quando esistono più posizioni di destinazione.",
		"Controlla il comportamento del comando \'Vai a definizione di tipo\' quando esistono più posizioni di destinazione.",
		...
		"ID comando alternativo eseguito quando il risultato di \'Vai a definizione\' è la posizione corrente.",
		"ID comando alternativo eseguito quando il risultato di \'Vai a definizione di tipo\' è la posizione corrente.",
		...
		"Esegue il rendering dei righelli verticali dopo un certo numero di caratteri a spaziatura fissa. Usare più valori  per più righelli. Se la matrice è vuota, non vengono disegnati righelli.",
		...
		"Consente di controllare se mostrare o nascondere le icone nei suggerimenti.",
		"Consente di controllare il numero di suggerimenti mostrati da IntelliSense prima di visualizzare una barra di scorrimento (massimo 15).",
		...
		"Contenuto editor",
		"Utilizza le configurazioni del linguaggio per determinare la chiusura automatica delle parentesi.",
		...
		"Utilizza le configurazioni del linguaggio per determinare la chiusura automatica delle virgolette.",
		...
		"Consente di controllare in che modo l\'editor deve eseguire il rendering dell\'evidenziazione di riga corrente.",
		...
		"Dimensione del carattere per il widget dei suggerimenti. Se impostato su \'0\', viene utilizzato il valore di \'#editor.fontSize#\'.",
		"Altezza della riga per il widget dei suggerimenti. Se impostato su \'0\', viene utilizzato il valore \'#editor.lineHeight#\'.",
		...
		"Controlla il wrapping delle righe.",
	...
	"vs/editor/common/standaloneStrings": [
		...
		"{0} selezioni",
		"Modifica dell\'impostazione \'accessibilitySupport\' su \'on\' in corso.",
		"Apertura della pagina di documentazione sull\'accessibilità dell\'editor in corso.",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Colore del bordo della barra di ridimensionamento dei widget dell\'editor. Il colore viene utilizzato solo se il widget sceglie di avere un bordo di ridimensionamento e se il colore non è sottoposto ad override da un widget.",
		...
		"Colore di primo piano delle voci di menu.",
		"Colore di sfondo delle voci di menu.",
		"Colore di primo piano della voce di menu selezionata nei menu.",
