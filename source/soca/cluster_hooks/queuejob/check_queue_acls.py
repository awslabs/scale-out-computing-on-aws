...
def find_users_in_ldap_group(group_dn):
    if os.path.isdir(
        ...
        pbs.logmsg(
            pbs.LOG_DEBUG,
            "queue_acl: generated ldapsearch command: "
        ...
        pbs.logmsg(
            pbs.LOG_DEBUG, "queue_acl: generated ldapsearch command: " + ldapsearch
        )

    users_in_group = os.popen(ldapsearch).read()  # nosec
    pbs.logmsg(
        pbs.LOG_DEBUG, "queue_acl: find_users_in_ldap_group" + str(users_in_group)
    )
