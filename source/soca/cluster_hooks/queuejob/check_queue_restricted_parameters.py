...
import hook check_queue_restricted_parameters application/x-python default /opt/soca/%SOCA_CLUSTER_ID/cluster_hooks/queuejob/check_queue_restricted_parameters.py
