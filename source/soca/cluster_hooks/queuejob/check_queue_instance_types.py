...
try:
    ...
    message = (
        ...
        + queue_settings_file
        + ". Double chek the YAML syntax is correct and you don't have any invalid indent.\n Error: "
        + str(err)
    )
    e.reject(message)
        ...
        if job_queue in queues:
            ...
            if "allowed_instance_types" not in v.keys():
                e.reject(
                    ...
                    + queue_settings_file
                    + ". See https://awslabs.github.io/scale-out-computing-on-aws/tutorials/manage-queue-instance-types/ for examples"
                )
