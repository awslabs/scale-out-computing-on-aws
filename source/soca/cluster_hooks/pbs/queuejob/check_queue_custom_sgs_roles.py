...
import hook check_queue_custom_sgs_roles application/x-python default /opt/soca/%SOCA_CLUSTER_ID/cluster_hooks/pbs/queuejob/check_queue_custom_sgs_roles.py
