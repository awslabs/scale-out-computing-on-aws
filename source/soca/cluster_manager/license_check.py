...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--server", nargs="?", required=True, help="FlexLM hostname")
    parser.add_argument("-p", "--port", nargs="?", required=True, help="FlexLM Port")
    parser.add_argument("-f", "--feature", nargs="?", required=True, help="FlexLM Feature")
    parser.add_argument(
        "-m", "--minus", nargs="?", help="Prevent HPC to consume all license by keeping a reserved pool for local usage"
    )
