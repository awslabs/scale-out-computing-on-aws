...
class ResizeTargetNode(Resource):
    @private_api
    ...
    def put(self):
        ...
        logger.info(f"Received parameter for resizing target node: {args}")
        ...
        _check_session = (
            ...
            .filter(
                ...
                TargetNodeSessions.session_uuid == _session_uuid,
            )
            .add_columns(
        ...
        if _check_session:
            session_info = _check_session[0]  # TargetNodeSessions
