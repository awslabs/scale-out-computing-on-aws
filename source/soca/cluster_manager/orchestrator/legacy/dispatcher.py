...
import orchestrator.legacy.add_nodes as add_nodes
...
if __name__ == "__main__":
    ...
    autoscaling = get_boto(service_name="autoscaling").message
    ...
    try:
        ...
        print(
            f"Unable to read queue settings file ({queue_settings_file}) with error: {err}"
        )
        sys.exit(1)
