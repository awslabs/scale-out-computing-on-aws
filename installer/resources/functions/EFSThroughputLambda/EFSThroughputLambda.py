    ...
    if efsAverageBurstCreditBalance < int(os.environ["EFSBurstCreditLowThreshold"]):
        ...
        if ThroughputMode == "bursting":
            ...
            response = efs_client.update_file_system(
                FileSystemId=FileSystemId, ThroughputMode="provisioned", ProvisionedThroughputInMibps=5.0
            )
        ...
        if ThroughputMode == "provisioned":
            ...
            response = efs_client.update_file_system(FileSystemId=FileSystemId, ThroughputMode="bursting")
